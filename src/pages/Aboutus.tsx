...
const About: React.FC = () => {
    return (
      <div className="bg-black text-white max-w-screen w-screen">
        ...
        <div className="bg-[#0F0F0F] lg:h-[70vh] py-5">

        
        <section className="bg-[#0F0F0F] lg:h-[20vh] mb-10 px-4 lg:px-32 pt-10">
        ...
        {/* Team Section */}
        <section className="px-4 lg:px-32 pt-10 bg-[#0F0F0F] lg:h-[30vh]">
